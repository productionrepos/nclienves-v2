...
$plantilla = file_get_contents('etiqueta2.html');


foreach($bultos as $datos_bulto) {

	$html = preg_replace_callback("|{(\w*)}|",function ($matches) use ($datos_bulto) {return $datos_bulto[$matches[1]];},$plantilla);
	$mpdf->WriteHTML($html);
}
