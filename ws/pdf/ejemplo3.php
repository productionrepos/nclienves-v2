...
$mpdf->SetTitle("Acme Trading Co. - Invoice"); // nombre archivo
$mpdf->SetAuthor("Acme Trading Co."); // no se de que sirve
...
$mpdf->Output(); //esta no se descarga se visualiza en web